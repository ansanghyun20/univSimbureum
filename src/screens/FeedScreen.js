...
import {Button, StyleSheet, Platform, SafeAreaView, useColorScheme, StatusBar, ScrollView, View, Text, TextInput, TouchableOpacity, FlatList} from 'react-native';
...
export default HomeScreen = (props) => {
    ...
    const renderItem = ({ item }) => {
        ...
        return (
            // TODO: 상세 게시물 조회 하는거 구현 부분
            <TouchableOpacity   title = { item.title  +  ' ' + item.content }   onPress={() => { navigation.navigate("ShowDetailPost", {title: item.title, content: item.content, writerName : item.nickName, writergrade : item.writergrade, price : item.price, }) }} >  
